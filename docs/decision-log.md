...
| 2026-09 | Answer floor is the measured 1.5B rate | Run 36168382696 scored 15/22 (0.682) twice on the CI subset after the conflict note started quoting whole clauses. `answer_accuracy` is 0.68. Conflict and injection stay at 1.00. The job grades only the rows it answered | A later 1.5B run that drops one more row goes red again |
